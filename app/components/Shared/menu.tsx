...
export const Menu = () => {
    ...
    return (
        ...
        <><div className="menu_container max-w-[500px] w-full mx-auto fixed bottom-0 left-2/4 translate-x-[-50%] bg-[#2D2D4F] rounded-t-[16px] flex justify-between items-center py-[22px] px-[20px]">
            ...
            <div className="menu_container max-w-[380px] w-full max-h-[53px] h-full absolute top-0.5 bg-[#2D2D4F] rounded-[13px] mx-auto left-2/4 translate-x-[-50%] text-center text-white font-light flex justify-center items-center">Добавить задачу</div></>
    )
