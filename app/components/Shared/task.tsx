...
{status =='process' && <div className='flex w-full justify-center gap-[13px] mt-[20px]'>
          <svg onClick={()=> taskService.acceptTask(taskId as string,router,showNotification,Query)} width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="50" height="50" rx="8" fill="#A2E9BA"/>
            <path d="M10 25L20 35L40 15" stroke="white" strokeWidth="6"/>
          </svg>
          <svg onClick={()=> taskService.cancelTask(taskId as string,router,showNotification,Query)} width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
