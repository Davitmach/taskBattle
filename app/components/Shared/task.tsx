...
{mytask==true && status =='process' && <div className='flex w-full justify-center gap-[13px] mt-[20px]'>
        ...
        {mytask==false &&
       <div className='w-full flex items-center justify-center'><button  disabled={ready=='false'?false:true} className={`w-[139px] h-[50px] rounded-[20px] ${ready=='false'?'bg-[#FF4D6D]' :'bg-[#ff4d6d87]'} text-[white] text-[20px] ${ready=='false'?'cursor-pointer':"cursor-not-allowed"}`} >Ready</button></div>
        } 
