...
const Delete = async (e: React.MouseEvent<HTMLOrSVGElement>) => {
  ...
  if (props.id && props.friendId) {
    ...
    return(
<li onClick={handleClick} style={{background:props.color}} key={props.index} className={`duration-[200ms] active:scale-[0.9] flex items-center gap-2  rounded-[13px] p-[9px] justify-between cursor-pointer ${props.className && props.className}`}>
