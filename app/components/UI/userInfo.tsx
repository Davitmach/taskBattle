...
router('/user/:id',{id:3455})
    ...
    return(
<li onClick={handleClick} style={{background:props.color}} key={props.index} className={`flex items-center gap-2  rounded-[13px] p-[9px] justify-between ${props.className && props.className}`}>
