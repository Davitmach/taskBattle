...
return(
    <svg onClick={props.onclick} className={`${props.className} duration-[200ms] active:scale-[0.9]`} width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
