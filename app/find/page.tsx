...
router('/');
    ...
    return(
        <div className="w-full h-[100vh] anim_fadeIn">
            ...
            <div className="search_input  w-full relative"><input placeholder="Напиши имя человека..." /><svg className="absolute top-[50%] translate-y-[-50%] right-[15px] cursor-pointer" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
